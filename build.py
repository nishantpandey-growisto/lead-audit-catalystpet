...
def main():
    ...
    replacements = {
        ...
        "{{PS_CLIENT_INP}}": client_crux.get("inp", "N/A") if client_crux.get("inp") else ("N/A" if not client_crux.get("inp_ms") else f"{client_crux['inp_ms']}\u00a0ms"),
        "{{PS_CLIENT_INP_CLASS}}": client_crux.get("inp_class", "") if client_crux.get("inp_class") else ("cwv-pass" if client_crux.get("inp_ms") and client_crux["inp_ms"] <= 200 else ("cwv-needs-improvement" if client_crux.get("inp_ms") and client_crux["inp_ms"] <= 500 else ("cwv-fail" if client_crux.get("inp_ms") else ""))),
        "{{PS_CLIENT_INP_STATUS}}": client_crux.get("inp_status", "") if client_crux.get("inp_status") else ("pass" if client_crux.get("inp_ms") and client_crux["inp_ms"] <= 200 else ("needs-improvement" if client_crux.get("inp_ms") and client_crux["inp_ms"] <= 500 else ("fail" if client_crux.get("inp_ms") else ""))),
        "{{PS_CLIENT_INP_LABEL}}": client_crux.get("inp_label", "") if client_crux.get("inp_label") else ("Pass" if client_crux.get("inp_ms") and client_crux["inp_ms"] <= 200 else ("Needs Improvement" if client_crux.get("inp_ms") and client_crux["inp_ms"] <= 500 else ("Fail" if client_crux.get("inp_ms") else "N/A"))),
